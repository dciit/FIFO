...
{
    internal class ClsOraConnection
    {
        ...
        public DataTable Query(string queryStr)
        {
            ...
            if (useDB)
            {
                ...
                {
                    MessageBox.Show("มีปัญหาด้านการเชื่อมต่อระบบ Network กรุณาติดต่อ IT" + ex.ToString());
                }
        ...
        public DataTable Query(OracleCommand commandDb)
        {
            ...
            if (useDB)
            {
                ...
                {
                    MessageBox.Show("มีปัญหาด้านการเชื่อมต่อระบบ Network กรุณาติดต่อ IT"+ oradb + ex.ToString());
                }
